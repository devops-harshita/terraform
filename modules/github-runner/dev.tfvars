...
sudo -u ubuntu ./config.sh --url https://github.com/devops-harshita/terraform --token BKOHPKVHZU6M3AITPJ2HYS3HAKY6G --name "runner-$(hostname)" --work _work --labels default --runnergroup default --unattended
./run.sh --once
./svc.sh install
./svc.sh start
